        ...
        <div class="dropdown">
            <div class="user col align-self-end">
                {{-- <img src="{{asset('assets/images/faces/1.jpg')}}" id="userDropdown" alt="" data-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false"> --}}
                    <div class="rounded-circle header-icon" id="userDropdown" alt="" data-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">
                        <i class="i-Boy"></i>
                    </div>
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                    <a href="{{ route('edit-user', ['uuid' => \Auth::user()->uuid]) }}" class="dropdown-item">Pengaturan profil</a>
                    <a href="{{ route('edit-password-user', ['uuid' => \Auth::user()->uuid]) }}" class="dropdown-item">Ubah Password</a>
                    <a class="dropdown-item d-flex align-items-center" href="{{ route('logout') }}"><i class="i-Power-2 text-danger  mr-1 font-weight-bold"></i> Sign out</a>
                </div>
            </div>
        </div>
    </div>
