    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card text-left">
                <form action="{{ route('report-fee-transfers') }}" method="get">
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-12">
                            ...
                            <div class="row col-md-12">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label>Guide</label>
                                    <div class="input-group">
                                        <select class="js-autocomplete form-control" name="guide_id" data-selected="{{$guide_id}}" value="{{$guide_id}}">
                                            <option value="">-- Semua guide --</option>
                                            @foreach ($guides as $item)
                                                <option value="{{$item->id}}" {{($item->id == $guide_id)? 'selected': ''}}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        @if (count($data) > 0)
                            <div class="d-md-flex mb-3 justify-content-between">
                                <a href="{{ route('report-fee-transfers', ['download' => true, 'startDate' => $startDate, 'endDate' => $endDate, 'guide_id' => $guide_id]) }}" class="btn btn-success"><i class="i-Download text-18 mr-2"></i> Download</a>
