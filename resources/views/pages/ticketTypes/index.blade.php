					...
					<div class="row mb-3">
                        ...
                        @if (count($data) > 0)
                            <div class="col-md-6 text-right">
                                <a href="{{ route('new-ticket-type') }}" class="btn btn-sm btn-info">
                                    ...
                                    @foreach ($data as $key => $item)
                                        <tr>
                                            ...
                                            <td width="80">
                                                ...
                                                <a href="{{ route('delete-ticket-type', ['slug' => $item->slug]) }}" class="text-danger mr-2 alert-confirm" data-toggle="tooltip" data-placement="bottom" id="" title="Delete">
