    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card text-left">
                <form action="{{ route('report-tickets') }}" method="get">
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-12">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6"><h4>Laporan Tiket</h4></div>
                        </div>
                        <div>
                        ...
                        <div class="d-md-flex mb-3 justify-content-between">
                            <a href="{{ route('report-tickets', ['download' => true, 'status' => $status]) }}" class="btn btn-success"><i class="i-Download text-18 mr-2"></i> Download</a>
